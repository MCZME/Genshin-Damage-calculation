...
class Artifact:
    ...
    def to_dict(self) -> Dict[str, Any]:
        return {"name": self.name, "piece": self.piece.name, "main": self.main, "sub": self.sub}
...
class ArtifactManager:
    ...
    def __init__(self, artifacts: List[Artifact], character: Any):
        ...
        self.artifacts: Dict[str, Optional[Artifact]] = {
            "Flower_of_Life": None, "Plume_of_Death": None, "Sands_of_Eon": None,
            "Goblet_of_Eonothem": None, "Circlet_of_Logos": None
        }
    ...
    def set_effect(self) -> None:
        ...
        for name, count in set_counts.items():
            ...
            effect_instance = cls()
            if count >= 2: effect_instance.apply_2_set_effect(self.character)
            if count >= 4: effect_instance.apply_4_set_effect(self.character)
